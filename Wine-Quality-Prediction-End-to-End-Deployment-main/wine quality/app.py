...
def predict():
    if request.method == 'POST':
        ...
        filename=r'D:\poai\Wine-Quality-Prediction-End-to-End-Deployment-main\Wine-Quality-Prediction-End-to-End-Deployment-main\wine quality\random_model.pickle'
